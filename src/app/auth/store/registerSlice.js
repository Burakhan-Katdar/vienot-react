...
export const submitRegister =
	(formValues, twitterUserName, twitterOauthToken, twitterOauthSecretToken, phoneNumberGSM) => async dispatch => {
		return jwtService
			.createUser(formValues, twitterUserName, twitterOauthToken, twitterOauthSecretToken, phoneNumberGSM)
			.then(user => {
